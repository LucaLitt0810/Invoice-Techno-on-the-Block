                  ...
                  filteredCustomers.map((customer) => (
                    <tr key={customer.id} className="table-row">
                      ...
                      <td className="table-cell">
                        <a href={`mailto:${customer.email}`} className="text-gray-400 hover:text-white transition-colors">
                          {customer.email}
                        </a>
                      </td>
                      ...
                      <td className="table-cell">
                        <div className="flex items-center space-x-1">
                          <Link href={`/customer-detail/${customer.id}`} className="w-8 h-8 flex items-center justify-center rounded-lg text-gray-400 hover:text-white hover:bg-white/[0.05] transition-all" title="View">
                            <EyeIcon className="h-4 w-4" />
                          </Link>
                          <Link href={`/customer-detail/${customer.id}/edit`} className="w-8 h-8 flex items-center justify-center rounded-lg text-gray-400 hover:text-blue-400 hover:bg-blue-500/[0.05] transition-all" title="Edit">
                            <PencilIcon className="h-4 w-4" />
                          </Link>
                          <button onClick={() => handleDeleteCustomer(customer.id)} className="w-8 h-8 flex items-center justify-center rounded-lg text-gray-400 hover:text-red-400 hover:bg-red-500/[0.05] transition-all" title="Delete">
