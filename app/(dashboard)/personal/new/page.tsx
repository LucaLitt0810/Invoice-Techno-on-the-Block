    ...
    <div className="max-w-4xl mx-auto space-y-8">
      <div className="md:flex md:items-center md:justify-between">
        <div className="flex-1 min-w-0">
          ...
          <h2 className="text-2xl font-bold text-white uppercase tracking-tight">New Employee</h2>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="card bg-dark-800 space-y-8">
                  ...
                  {departments.map((d) => {
                    ...
                    return (
                      <button
                        ...
                        type="button"
                        onClick={() => {
                          if (d.id === formData.department_id) return; // skip main dept
                          setFormData((prev) => ({
                            ...prev,
        ...
        <div className="px-8 py-5 border-t border-dark-500 flex justify-end space-x-4">
          <Link href="/personal" className="px-6 py-3 border border-dark-500 text-gray-300 hover:text-white hover:border-white transition-colors text-sm font-medium uppercase tracking-wider">
            Cancel
          </Link>
