                ...
                <tr key={customer.id} className="table-row">
                  ...
                  <td className="table-cell">
                    <div className="flex items-center space-x-1">
                      ...
                      <button onClick={() => handleDelete(customer.id)} className="w-8 h-8 flex items-center justify-center rounded-lg text-gray-400 hover:text-red-400 hover:bg-red-500/[0.05] transition-all" title="Delete">
